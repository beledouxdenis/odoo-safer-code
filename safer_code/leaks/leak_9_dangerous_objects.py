...
class ResCompany(models.Model):
    ...
    def _l10n_xx_get_certificate_and_key_objects(self, password=None):
        ...
        try:
            return (
                x509.load_pem_x509_certificate(stored_certificate),
                serialization.load_pem_private_key(stored_key, password or None),
            )
        except TypeError:
            raise UserError(
                _("The certificate or private key you uploaded is encrypted. Please specify your password.")
            )
